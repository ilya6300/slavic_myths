...
export const spirits: SpiritDefinition[] = [
  ...
  },
  {
    ...
    bookRewardDescription:
      '+10% к монетам с клика с 11:00 до 15:00 (дневной бонус, навсегда). Открывается ключом из сундука.',
    loseMessage:
  ...
  },
  {
    ...
    bookRewardDescription:
      '−20% к шансу появления Жирдяя ночью (пассивно, навсегда). Открывается ключом из сундука.',
    loseMessage:
  ...
  },
  {
    ...
    bookRewardDescription:
      'Уникальный скин избы «Гармония» (можно выбрать в профиле / скинах). Условие: 3 фрагмента.',
    ...
    miniTale:
      'Сказ о вазе и тихой избе. Я не спорил, не торопил и поправил кривой цветок у порога. Лада улыбнулась — и стены стали мягче светом. Ваза с цветами осталась нам. В старину лад в доме берегли как огонь: без согласия ни урожай, ни любовь не держатся.',
    hasTrophy: true,
  ...
  },
  {
    ...
    bookRewardDescription:
      'Титул «Лапа Велеса» (в профиле). Условие: 4 фрагмента.',
  ...
  },
  {
    ...
    bookRewardDescription:
      'Скин леса за окном: видна избушка на курьих ножках. Условие: 3 фрагмента.',
    loseMessage:
  ...
  },
  {
    ...
    bookRewardDescription:
      '+20 к cap монет удачи (до 220) и титул «Разгадчик Смерти». Условие: 6 фрагментов.',
    loseMessage:
