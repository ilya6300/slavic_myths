...
export const spirits: SpiritDefinition[] = [
  ...
  },
  {
    ...
    miniTale:
      'Сказ о вазе и тихом ладе. В избе снова спорили из-за пустяка, а я не стал разнимать лапами: подвинул на стол глиняную вазу и замолчал, как будто дом сам вспомнил слово «лад». Ссора осела, усы остались сухие, а ваза так и стоит — не кумир с холма, а знак, что своим лучше жить в порядке. В народе помнят: лад — это мир семьи.',
    hasTrophy: true,
  ...
  },
  {
    ...
    miniTale:
      'Сказ о тайнике не в плече. К сундукам я лапу не тянул и чаши за печь ему не ставил: сел напротив и спросил, где у него жизнь, если не в худых костях. Он усмехнулся в сухие усы — и на лапу легла игла в хрустальном яйце, будто сам терем кивнул. В народе помнят: Кощею нет храма; его сила лежит в стороне, и жадность к терему её не берёт.',
    hasTrophy: true,
    reward: {
  ...
  },
  {
    ...
    lockedHint: '8 осколков. После него — Ярило и Перун.',
  },
  {
    id: 'yarilo',
    name: 'Ярило',
  ...
  },
  {
    ...
    lockedHint: '10 осколков. Финал книги — Перун.',
  },
];
