...
| HUD: сметана | Да — полное восстановление энергии | По необходимости |
...
| `energy` | `.hud-energy` | `top: 8px; left: 50%; transform: translateX(-50%)` | Число + полоска; при 0 — пульс + кнопка «Миска сметаны» (rewarded) |
...
| `miracle-progress` | `.hud-miracle` | под монетами | Только если Сундук чудес активен: `Удачи до чуда: 612/1000` |
...
<aside class="layer-hud room-hud">
  ...
  <button type="button" class="hud-smetana" hidden
    ...
    <img src="assets/ui/icon_smetana.png"
         alt="Сметана — полное восстановление энергии" />
    <span>×1</span>
  </button>

  <div class="hud-miracle" hidden>
    <span>Удачи до чуда: <strong>612</strong>/1000</span>
  </div>
</aside>
```
