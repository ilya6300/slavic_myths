...
**Правило для агентов по арту:** отсутствующий ассет → обновить промпт в `design_assets_prompts.md`. **Не** рисовать SVG/CSS/сгенерированные картинки вместо файла из `assets_catalog.md`.
