...
### `assets/ui/icon_candle.png`

**Экран:** HUD `.hud-candle` (`GameHud`). Ресурс гадания в зеркале.  
**Бриф:** `instruction/design/icon_candle_hud_brief.md` (перерисовка 2026-09-25 — убрать фаллический силуэт).

```
Предмет: иконка HUD «зажжённая свеча» для казуальной игры «Книга славянских духов». Компактный значок инвентаря, как монета или миска сметаны: в центре кадра коническая пчелиная свеча в низком глиняном подсвечнике-тарелке. Свеча сужается к фитилю, у основания чуть шире; на воске одна-две капли, мёдовый кремовый цвет, не телесный розовый. Пламя маленькое, тёплое жёлто-оранжевое. На воске едва заметное тиснение узора молнии (славянский орнамент), не крупный щит на весь ствол. Подставка — плоская широкая чашечка из терракотовой глины с простым геометрическим орнаментом по ободу, без вертикального стержня и без раздувающегося шара внизу.

Стиль: объёмный стилизованный 3D-рендер, пластилин / полимерная глина, matte tactile, как остальные иконки HUD. Мягкие толстые формы, следы лепки, без глянца и неона.

Освещение: мягкий студийный свет сверху-слева, тёплые тени у тарелки, лёгкое свечение от пламени. Палитра: мёд, кремовый воск, терракота, тёплый коричневый.

Композиция: только свеча и подсвечник, вертикальная ориентация, силуэт читается при 32 пикселях. Сплошной чёрный фон, без текста, рамок, зеркала, рук, персонажей.

Референс стиля: assets/UI/icon_smetana.png (масштаб HUD, глина, тарелка) и assets/UI/icon_energy.png (плотность деталей). Повторить визуальный язык приложенных референсов из assets/.

Чего не должно быть: толстый цилиндр одинаковой ширины; высокая подставка-бутылка; раздувающееся основание; телесный воск; огромная молния на стволе; вектор, flat, emoji, фотореализм, неон, глянцевый пластик, фаллический силуэт, текст, водяной знак.
```
