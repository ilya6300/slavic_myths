...
lines.push("| Леший | Хозяин лесной чащи | То кружит след, то сам выводит старичком в белом |");
lines.push("| Водяной | Своенравный хозяин омута | Встреча у воды не дружба; дар отдают целиком |");
...
lines.push("    - Фольклор из книги: рябина и голое дерево у Лешего (соль — оберег), Банник строг к пару и порогу, народная русалка в белой рубахе на берёзе без рыбьего хвоста, Кикимора домашняя в избе/углах.");
